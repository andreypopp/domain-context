...
exports.run = function(func, options) {
  var cleanup, init, onError;

  init = options.init, cleanup = options.cleanup, onError = options.onError;
...
exports.runInNewDomain = function(func, options) {
  var currentDomain;
  ...
  return exports.run(func, options);
};
